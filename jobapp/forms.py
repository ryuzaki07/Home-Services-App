...
class JobForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['title'].widget.attrs.update(
            {
                'placeholder': 'eg : Electritcian Carpenter Plumber Cook',
            }
        )        
        self.fields['location'].widget.attrs.update(
            {
                'placeholder': 'eg : Athwa Surat Vesu',
            }
        )
        self.fields['salary'].widget.attrs.update(
            {
                'placeholder': 'Rs.2000-5000 Per month',
            }
        )
        self.fields['tags'].widget.attrs.update(
            {
                'placeholder': 'Use comma separated. eg: Electrical, Repair, Cook, Food, Carpentry',
            }
        )                        
        ...
        self.fields['company_name'].widget.attrs.update(
            {
                'placeholder': 'Company Name Or Orginization Name',
            }
        )           
